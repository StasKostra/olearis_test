...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<String> itemsList});
}
...
class _$InitialImpl implements _Initial {
  const _$InitialImpl({final List<String> itemsList = const []})
  ...
  @override
  String toString() {
    return 'HomeState(itemsList: $itemsList)';
  }
...
abstract class _Initial implements HomeState {
  const factory _Initial({final List<String> itemsList}) = _$InitialImpl;
